...
2. Run "python -m http.server 8000" to start a simple web server
...
If you are familiar with JS you might be finding the syntax on our index.js file a bit weird. That's
because that is not javascript, that's a JS extension called JSX. It was designed by the developers behind
...
There's no shame on that and it won't affect your test. We believe being able to learn is also about being able
to ask the right questions as well. So hit me with your best questions!
